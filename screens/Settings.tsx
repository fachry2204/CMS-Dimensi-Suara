  ...
  const fetchGatewaySettings = async () => {
      ...
      try {
          ...
          if (data?.mpwa) setMpwa({
              ...
              enabled: Boolean(data.mpwa.enabled)
          });
      } catch (err) {
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="md:col-span-2">
                                ...
                                <select 
                                    ...
                                    className="w-full px-4 py-2 border border-gray-200 rounded-xl focus:border-blue-500 outline-none bg-slate-50 focus:bg-white transition-colors"
                                >
                                    <option value="false">Tidak Aktif</option>
                                    <option value="true">Aktif (Kirim Notifikasi Otomatis)</option>
                                </select>
                                <p className="text-[10px] text-slate-400 mt-1">Jika aktif, sistem akan mengirim notifikasi WhatsApp otomatis untuk setiap perubahan status.</p>
                            </div>
                            <div className="md:col-span-2">
